...
class Player extends events_1.EventEmitter {
   ...
   **/
    ...
    loadSounds(sounds) {
        return __awaiter(this, void 0, void 0, function* () {
            const loadSounds = yield scripts.loadSounds(sounds);
            return loadSounds.send(this.socket);
        });
    }
    playSound(sound) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, soundIds_1.default)(sound, "play", this.socket);
        });
    }
    stopSound(sound) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, soundIds_1.default)(sound, "stop", this.socket);
        });
    }
    destroySound(sound) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, soundIds_1.default)(sound, "destroy", this.socket);
        });
    }
    ...
    setGravity(gravityValue) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, playerIds_1.default)(this, "o")
                .send(this.socket);
        });
    }
    _getClients() {
  ...
  * ```
   */
    ...
    grantBadge(badgeId) {
        return __awaiter(this, void 0, void 0, function* () {
            return scripts.playerGrantBadge(Game_1.default.serverSettings.hostKey, this.validationToken, badgeId);
        });
    }
    // /**
    ...
    _joined() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sounds = yield scripts.loadSounds(Game_1.default.world.sounds);
            if (sounds)
                yield sounds.send(this.socket);
            this._createTeams();
            this._createTools();
            this._createBots();
